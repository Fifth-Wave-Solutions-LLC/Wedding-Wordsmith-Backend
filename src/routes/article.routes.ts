...
articleRouter.get("/api/articles", authenticate, ArticleController.getAllArticles); // add middleware
// articleRouter.get("/api/articles/:id",  ArticleController.getArticleById); // add middleware
articleRouter.post("/api/articles", authenticate, ArticleController.createArticle);
